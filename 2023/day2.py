...
puzzle_data_test = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green""".split('\n')

puzzle_data = """Game 1: 9 red, 2 green, 13 blue; 10 blue, 2 green, 13 red; 8 blue, 3 red, 6 green; 5 green, 2 red, 1 blue
...
Game 100: 5 blue, 5 green; 7 blue, 15 green; 4 red, 7 green, 12 blue; 7 green, 1 blue; 5 blue, 9 green, 1 red""".split('\n')
    ...
    for line in data:
        ...
        for rnd in game:
            ...
            for cubes in rnd.split(','):
                ...
                round_cubes[cube_color] = cube_count

            if int(round_cubes.get('red', 0)) > max_cubes.get('red') or \
               int(round_cubes.get('green', 0)) > max_cubes.get('green') or \
               int(round_cubes.get('blue', 0)) > max_cubes.get('blue'):
                impossible_games.append(int(game_id))

    for x in range(100):
        if x+1 not in impossible_games:
            possible_games.append(x+1)
...
def part2(data) -> int:
    ...
    for line in data:
        ...
        for rnd in game:
            ...
            if int(round_cubes.get('red', 0)) >= min_cubes.get('red'):
                min_cubes['red'] = int(round_cubes.get('red', 0))
            if int(round_cubes.get('green', 0)) >= min_cubes.get('green'):
                min_cubes['green'] = int(round_cubes.get('green', 0))
            if int(round_cubes.get('blue', 0)) >= min_cubes.get('blue'):
                min_cubes['blue'] = int(round_cubes.get('blue', 0))
